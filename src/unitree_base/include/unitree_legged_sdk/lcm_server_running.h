...
#ifndef _UNITREE_LEGGED_LCM_SERVER_RUNNING_
#define _UNITREE_LEGGED_LCM_SERVER_RUNNING_
...
{
public:
    Lcm_Server_High(LeggedType rname): udp(8081, "192.168.123.161", 8082, 
                      HIGH_CMD_LENGTH, HIGH_STATE_LENGTH), mylcm(HIGHLEVEL){
        udp.InitCmdData(cmd);
    }
    void UDPRecv(){
        udp.Recv();
